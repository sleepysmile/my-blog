...
class SettingsCrudController extends CrudController
{
    ...
    {
        parent::__construct();
        $this->model = app()->get(SettingsManager::SINGLETON_NAME);
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('option_name');
        CRUD::column('option_value');
    ...
    {
        $crud = $this->crud;
        $crud->removeColumn('is_internal');
        $crud->removeColumn('option_type');
